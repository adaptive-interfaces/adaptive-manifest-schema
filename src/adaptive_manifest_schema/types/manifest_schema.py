...
Kept in its own file because manifest schema is a distinct artifact
with a stable repeated entry shape.
"""

from typing import TypedDict

from adaptive_manifest_schema.types.primitives import ArtifactMeta
