"""validate_contract.py - Version and tag alignment for adaptive-manifest-schema.
...
from adaptive_manifest_schema.load import get_git_tag
from adaptive_manifest_schema.sync import get_version_from_citation
